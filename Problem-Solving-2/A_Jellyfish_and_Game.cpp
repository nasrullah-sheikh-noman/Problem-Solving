...
void solve() {
  ...
  ll sum = 0;
  for(auto x: v1) sum+=x;
  int iv1 = min_element(v1.begin(), v1.end()) - v1.begin();
  int iv2 = max_element(v2.begin(), v2.end()) - v2.begin();
  if(v1[iv1] < v2[iv2]) {
    sum += v2[iv2] - v1[iv1];
    swap(v1[iv1], v2[iv2]);
  }
  ...
  iv1 = max_element(v1.begin(), v1.end()) - v1.begin();
  iv2 = min_element(v2.begin(), v2.end()) - v2.begin();
  if(v1[iv1] > v2[iv2]) {
    sum-=v1[iv1]-v2[iv2];
    swap(v1[iv1], v2[iv2]);
  }
